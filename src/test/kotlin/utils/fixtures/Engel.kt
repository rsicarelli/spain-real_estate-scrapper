...
object Engel {
    ...
    inline fun <reified T> T.singleSearchResultWithMissingData() =
        Pair(
            htmlDocument(loadResource("/engel/engel-single-search-result-missing-data.txt")),
    ...
    inline fun <reified T> T.invalidSearchResult() =
        Pair(
            htmlDocument(loadResource("/engel/engel-invalid-search-result.txt")),
            null
        )
    ...
    object Fixtures {
        ...
        val defaultSearchResults = listOf(
            PropertySearchResult(
                ...
                bathCount = 2,
                imageUrl = "https://www.engel.es/engel-search-result_files/thumb(27)",
                tag = "",
                propertyUrl = "https://www.engel.es/valencia/san-francesc/piso-en-alquiler-de-dos-dormitorios-junto-a-plaza-de-la-reina",
            ),
            PropertySearchResult(
                reference = "AV2109032",
                price = 900.0,
                ...
                bathCount = 2,
                imageUrl = "https://www.engel.es/engel-search-result_files/thumb(28)",
                tag = "",
                propertyUrl = "https://www.engel.es/valencia/ruzafa/piso-el-alquiler-reformado-junto-a-gran-via"
            ),
            PropertySearchResult(
                reference = "AV2109027",
                price = 1100.0,
                ...
                bathCount = 2,
                imageUrl = "https://www.engel.es/engel-search-result_files/thumb(29)",
                tag = "Alquilada",
                propertyUrl = "https://www.engel.es/valencia/sant-pau/atico-en-alquiler-de-2-habitaciones-en-marina-alta"
            ),
            PropertySearchResult(
                ...
                bathCount = 2,
                imageUrl = "https://www.engel.es/engel-search-result_files/thumb(30)",
                tag = "Alquilada",
                propertyUrl = "https://www.engel.es/valencia/la-petxina/vivienda-en-alquiler-de-tres-habitaciones-en-la-petxina"
            ),
            PropertySearchResult(
                reference = "AV2109078",
                price = 750.0,
                ...
                bathCount = 2,
                imageUrl = "https://www.engel.es/engel-search-result_files/thumb(3)",
                tag = "Alquilada",
                propertyUrl = "https://www.engel.es/valencia/benimaclet/piso-en-alquiler-en-primado-reig"
            ),
            PropertySearchResult(
                ...
                bathCount = 3,
                imageUrl = "https://www.engel.es/engel-search-result_files/thumb(31)",
                tag = "Alquilada",
                propertyUrl = "https://www.engel.es/valencia/arrancapins/piso-en-alquiler-de-cinco-dormitorios-sin-amueblar-junto-a-plaza-pintor-segrelles"
            ),
            PropertySearchResult(
                reference = "AV2101119",
                price = 825.0,
                ...
                bathCount = 1,
                imageUrl = "https://www.engel.es/engel-search-result_files/thumb(32)",
                tag = "Nuevo",
                propertyUrl = "https://www.engel.es/valencia/arrancapins/**alquiler-**-de-apartamento-de-2-habitaciones-en-avenida-del-cid"
            ),
            PropertySearchResult(
                reference = "AV2106020",
                price = 2600.0,
                ...
                bathCount = 3,
                imageUrl = "https://www.engel.es/engel-search-result_files/thumb(33)",
                tag = "",
                propertyUrl = "https://www.engel.es/valencia/pla-del-remei/alquiler-de-vivienda-con-vistas-en-colon"
            ),
            PropertySearchResult(
                reference = "AV2109048",
                price = 750.0,
                ...
                bathCount = 1,
                imageUrl = "https://www.engel.es/engel-search-result_files/thumb(20)",
                tag = "Reservada",
                propertyUrl = "https://www.engel.es/valencia/patraix-vara-de-quart/av2109048-loft-en-alquiler-en-patraix"
            ),
            PropertySearchResult(
                ...
                bathCount = 2,
                imageUrl = "https://www.engel.es/engel-search-result_files/thumb(34)",
                tag = "",
                propertyUrl = "https://www.engel.es/valencia/patacona/piso-de-alquiler-temporal-de-2-habitaciones-en-playa-patacona"
            ),
        )

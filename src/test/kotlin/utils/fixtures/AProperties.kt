...
object AProperties {
    inline fun <reified T> T.defaultSearchResults(): Pair<Doc, List<PropertySearchResult>> {
        return Pair(htmlDocument(loadResource("/aproperties/aproperties-search-result.txt")), Fixtures.defaultSearchResults)
    }
    ...
    inline fun <reified T> T.emptySearchResult() = htmlDocument(loadResource("/aproperties/aproperties-empty-search-result.txt"))
